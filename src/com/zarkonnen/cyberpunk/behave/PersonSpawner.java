...
public enum PersonSpawner {
	...
	SECDL(1, DRUG_LAB, SECURITY_GUARD, APARTMENT, null, 300),
	SECC(1, CLINIC, SECURITY_GUARD, APARTMENT, null, 300),
	SECAG(1, ART_GALLERY, SECURITY_GUARD, APARTMENT, null, 300),
	SECPH(1, PENTHOUSE, SECURITY_GUARD, APARTMENT, null, 300);
